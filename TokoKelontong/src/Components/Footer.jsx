      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className={`grid gap-8 ${
          ...
          <div className={`${isMobile ? 'text-center' : 'text-left'}`}>
            <h3 className="text-xl font-bold mb-4">Natzsixn</h3>
            <p className="text-gray-400 mb-4">
              Solusi digital terdepan untuk kebutuhan bisnis modern Anda.
            </p>
          ...
          <div className={`${isMobile ? 'text-center' : 'text-left'}`}>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Tim</a></li>
        ...
        {/* Newsletter Section - Only show on desktop/tablet */}
        {!isMobile && (
          <div className="mt-8 pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h4 className="text-lg font-semibold mb-2">Berlangganan Newsletter</h4>
                <p className="text-gray-400">Dapatkan update terbaru dari kami</p>
              </div>
              <div className="flex w-full md:w-auto">
                <input
                  type="email"
                  placeholder="Masukkan email Anda"
                  className="flex-1 md:w-64 px-4 py-2 bg-gray-800 text-white border border-gray-700 rounded-l-lg focus:outline-none focus:border-blue-500"
                />
        ...
        <div className={`mt-8 pt-8 border-t border-gray-800 ${
          ...
          <div className={`text-gray-400 ${isMobile ? 'mb-4' : ''}`}>
            <p>&copy; 2024 Natzsixn. All rights reserved.</p>
          </div>
          ...
          {/* Powered by - Always centered on mobile */}
          <div className={`${isMobile ? 'mt-6 pt-4 border-t border-gray-800' : 'mt-2'}`}>
            <p className="text-gray-400">
              Powered by <a href="#" className="text-blue-500 hover:text-blue-400 transition-colors font-semibold">Natzsixn</a>
            </p>
          </div>
        </div>
      </div>
